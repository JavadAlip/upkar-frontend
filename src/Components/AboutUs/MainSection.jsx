  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // FIX: Read aboutMainList array correctly
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-3xl">
            ...
            >
              ...
              <div className="absolute top-4 left-4 z-10 text-left text-white">
                <div className="text-3xl sm:text-4xl font-bold mb-1">{data.plotNumber}</div>
            ...
            >
              <div className="absolute inset-0 bg-black/40"></div>
              <div className="absolute top-4 left-4 z-10 text-left text-white">
                <div className="text-3xl sm:text-4xl font-bold mb-1">{data.acresNumber}</div>
        ...
        <div className="relative w-full">
          <div className="rounded-[2rem] overflow-hidden shadow-lg relative h-[420px] sm:h-[500px] lg:h-[560px]">
            ...
            <div className="absolute bottom-5 left-1/2 -translate-x-1/2 flex gap-4 z-30">
              <button onClick={prevSlide} className="bg-white text-gray-800 p-2 rounded-full shadow-md">
                <ChevronLeft className="w-4 h-4" />
              </button>
              <button onClick={nextSlide} className="bg-[#050F27] text-white p-2 rounded-full shadow-md">
