...
//         // Show description after heading finishes
//         setTimeout(() => {
...
//   if (!project)
//     return <div className="text-center py-16">No upcoming project found</div>;
...
//           {/* LEFT CONTENT */}
//           <div>
//             <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl  leading-tight text-black mb-8 sm:mb-12 md:mb-16 lg:mb-[100px] text-left">
...
//             {/* Enquiry Button */}
//             <div
//               className={`flex justify-start transition-opacity duration-1000 ease-in-out ${
//                 showDescription ? 'opacity-100' : 'opacity-0'
//               }`}
//             >
//               <img
