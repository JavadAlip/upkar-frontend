    ...
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
      <div className="bg-white w-full max-w-lg max-h-[90vh] overflow-y-auto p-6 rounded shadow-lg relative">
        ...
        <h2 className="text-xl font-bold mb-4">
          {project.aboutHeading || 'About Project Details'}
        </h2>
        ...
        <div className="space-y-4">
          ...
          <div className="p-3 border rounded">
            ...
            <p className="text-gray-900">{project.aboutDescription}</p>
          </div>

          <div className="p-3 border rounded">
            <strong className="block mb-1 text-gray-700">RE Raising:</strong>
            <p className="text-gray-900">{project.reRaising}</p>
          </div>
          ...
          <div className="p-3 border rounded">
            ...
            <p className="text-gray-900">{project.reRadescription}</p>
          </div>
          ...
          <div className="p-3 border rounded">
            ...
            <p className="text-gray-900">{project.noBrokerHeading}</p>
          </div>
          ...
          <div className="p-3 border rounded">
            ...
            <p className="text-gray-900">{project.builderHeading}</p>
          </div>
        </div>
      </div>
    </div>
