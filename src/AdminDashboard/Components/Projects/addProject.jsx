...
//       if (formData.totalUnits && formData.totalUnits !== '')
...
//           data.append('propertyImages', image);
//         });
//       }
...
//   // Handle file upload for master plan image
...
//   //       if (plan.planPhoto) data.append('masterPlans', plan.planPhoto);
//   //     });
...
//   // Replace your handleSubmit function with this version that closes modal immediately:
...
//       // 🔔 Show loading toast
//       const toastId = toast.loading('Saving project... Please wait');
...
//       if (formData.projectArea)
//         data.append('projectArea', formData.projectArea);
//       if (formData.totalUnits) data.append('totalUnits', formData.totalUnits);
...
//       // 🔥 API CALL (happens in background after modal closes)
//       await createProjects(data, token);
...
//       // ❌ ERROR - Show error toast (modal already closed)
